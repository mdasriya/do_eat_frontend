...
const Header = () => {
  return (
    <div className='relative header h-full'>
      ...
      <marquee className="absolute top-0  text-white text-xl bg-red-600">🚀 Get ready for the ultimate food experience! Today marks the launch of our revolutionary food web app! Don't miss out on the excitement! 🎉 #FoodieRevolution</marquee>
    </div>
  );
}
