...
const Contact = () => {
  return (
    <div
            class="grid md:grid-cols-2 bg-[#212121] items-center overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto p-6 lg:h-[600px] ssm:h-[600px] my-6 font-[sans-serif]">
           <div className='mb-6'>
                    <h1 class="text-4xl font-bold text-white">Get in Touch</h1>
                    <p class=" text-gray-200 text-xl p-2 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
