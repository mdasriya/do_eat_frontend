...
const Contact = () => {
  return (
    <div
            class="grid md:grid-cols-2 bg-[#212121] items-center overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto p-6 h-[600px] my-6 font-[sans-serif]">
           <div className=''>
